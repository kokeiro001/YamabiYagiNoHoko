...
namespace GUI
{
	...
	typedef Kernel::Delegate01<const MouseWheelEventArgs&> DesktopMouseWheelEvent;
	...
	*/
	...
	public:
		...
		virtual void SetDesktopMouseWheelEvent( const DesktopMouseWheelEvent& Event ) = 0;
...
public:
	...
	*/
	...
	/**
		...
		@param Power	[in] 強度
		@note
		グレアの強度に関するパラメーターの設定を行います。
	*/
	virtual void SetParameter_GlarePower( float Power ) = 0;
